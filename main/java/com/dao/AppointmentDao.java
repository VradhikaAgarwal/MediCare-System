...
public class AppointmentDao {
    ...
    //get all the details of login user based on user Id to show in view appointment
    ...
    // getting all the appointment details of the patient which appoints to particular doctor 
    ...
    //to get the details of the patient to show to the doctor
    public Appointment getAllAppointmentById1(int id){
    ...
    //to update the status after being commented by the doctor
    ...
    //to show all the details of the patient to admin
    ...
    public List<Appointment> getAllAppointmentSortedByDate() {
    	List<Appointment> list=new ArrayList<Appointment>();
    	Appointment ap=null;
    	try {
